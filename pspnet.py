...
class PSPNet(object):
    _defaults = {
        # "model_path"        : 'logs/line_Epoch586-Total_Loss0.0909-Val_Loss0.0875.pth',
        "model_path": 'logs/line_Epoch1-Total_Loss0.6266-Val_Loss0.3943.pth',
    ...
    def generate(self):
        ...
        if self.num_classes == 2:
            ...
            self.colors = [(0, 0, 0), (128, 0, 0), (0, 128, 0), (128, 128, 0),
                    (255, 255, 255), (64, 0, 0), (192, 0, 0), (64, 128, 0), (192, 128, 0), (64, 0, 128), (192, 0, 128),
                    (64, 128, 128), (192, 128, 128), (0, 64, 0), (128, 64, 0), (0, 192, 0), (128, 192, 0), (0, 64, 128), (128, 64, 12)]
        else:
            # 画框设置不同的颜色
